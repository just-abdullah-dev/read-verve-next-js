...
export const getAllCategories = async (keyword = '') => {
    try {
        const url = `/api/category/getAll?keyword=${keyword}`;
        const options = {
            method: 'GET',
        };
    ...
    export const deleteCategory = async (token, id)=>{
        try {
        const url = `/api/category/delete?_id=${id}`;
    ...
    export const updateCategory = async (token, {id, name, slug})=>{
        try {
    ...
    export const createCategory = async (token, {name, slug})=>{
        try {
